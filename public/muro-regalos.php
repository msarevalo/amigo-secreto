...
<div style="position: relative;">
    <nav id="menu" class="left show">
        <ul>
            ...
            <li><a href="muro-regalos" class="active"><i class="fa fa-laptop"></i>Muro de los regalos</a></li>
...
<div id="texto">
    ...
    <form method=\"post\" action=\"../back/regaloedit.php\" id=\"publicar\" name='publicar'>
        <textarea required maxlength=\"600\" rows=\"5\" cols=\"85\" placeholder=\"¿Quieres un viaje, un carro, una casa? ¡Escribe aquí qué es lo que quieres!\" id=\"publicacion\" name=\"publicacion\" onpaste=\"contarcaracteres2();\" onkeyup=\"contarcaracteres2();\">" . $resregalo[0][2] . "</textarea><br>
    ...
    <form method=\"post\" action=\"../back/regalo.php\" id=\"publicar\" name='publicar'>
        <textarea required maxlength=\"600\" rows=\"5\" cols=\"85\" placeholder=\"¿Quieres un viaje, un carro, una casa? ¡Escribe aquí qué es lo que quieres!\" id=\"publicacion\" name=\"publicacion\" onpaste=\"contarcaracteres2();\" onkeyup=\"contarcaracteres2();\"></textarea><br>
        <img src=\"../img/emoji.png\" style=\"width: 20px; margin-left: 79%; cursor: pointer\" id=\"notificationLink\">
        <label id=\"res\" style=\"color: #bbbbbb;\">0 / 600</label><br>";
        if (sizeof($resas) != 0) {
        ...
        <div id="notificationsBody" class="notifications">
            ...
            <table id="natural" name="natural" style="display: none">
                ...
                <tr>
                    ...
                    <td><img src="../img/emojis/natural/1f42e.png" onclick="document.publicar.publicacion.value+='&#x1F42E'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/natural/1f430.png" onclick="document.publicar.publicacion.value+='&#x1F430'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/natural/1f432.png" onclick="document.publicar.publicacion.value+='&#x1F432'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/natural/1f43d.png" onclick="document.publicar.publicacion.value+='&#x1F43D'" style="width: 25px; cursor: pointer"></td>
                </tr>
            </table>
            <table id="comidas" name="comidas" style="display: none">
                <tr>
                    <td><img src="../img/emojis/comidas/1f345.png" onclick="document.publicar.publicacion.value+='&#x1F345'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f346.png" onclick="document.publicar.publicacion.value+='&#x1F346'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f347.png" onclick="document.publicar.publicacion.value+='&#x1F347'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f349.png" onclick="document.publicar.publicacion.value+='&#x1F349'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f34a.png" onclick="document.publicar.publicacion.value+='&#x1F34A'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f34c.png" onclick="document.publicar.publicacion.value+='&#x1F34C'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f34d.png" onclick="document.publicar.publicacion.value+='&#x1F34D'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f34e.png" onclick="document.publicar.publicacion.value+='&#x1F34E'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f34f.png" onclick="document.publicar.publicacion.value+='&#x1F34F'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f352.png" onclick="document.publicar.publicacion.value+='&#x1F352'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f354.png" onclick="document.publicar.publicacion.value+='&#x1F354'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f355.png" onclick="document.publicar.publicacion.value+='&#x1F355'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f356.png" onclick="document.publicar.publicacion.value+='&#x1F356'" style="width: 25px; cursor: pointer"></td>
                </tr>
                <tr>
                    <td><img src="../img/emojis/comidas/1f356.png" onclick="document.publicar.publicacion.value+='&#x1F356'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f357.png" onclick="document.publicar.publicacion.value+='&#x1F357'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f35f.png" onclick="document.publicar.publicacion.value+='&#x1F35F'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f366.png" onclick="document.publicar.publicacion.value+='&#x1F366'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f367.png" onclick="document.publicar.publicacion.value+='&#x1F367'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f369.png" onclick="document.publicar.publicacion.value+='&#x1F369'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f36a.png" onclick="document.publicar.publicacion.value+='&#x1F36A'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f36b.png" onclick="document.publicar.publicacion.value+='&#x1F36B'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f36c.png" onclick="document.publicar.publicacion.value+='&#x1F36C'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/comidas/1f36d.png" onclick="document.publicar.publicacion.value+='&#x1F36D'" style="width: 25px; cursor: pointer"></td>
            ...
            <table id="deportes" name="deportes" style="display: none">
                <tr>
                    <td><img src="../img/emojis/deportes/26bd.png" onclick="document.publicar.publicacion.value+='&#x26BD'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/26be.png" onclick="document.publicar.publicacion.value+='&#x26BE'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/26f3.png" onclick="document.publicar.publicacion.value+='&#x26F3'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/26f5.png" onclick="document.publicar.publicacion.value+='&#x26F5'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/26fa.png" onclick="document.publicar.publicacion.value+='&#x26FA'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3a3.png" onclick="document.publicar.publicacion.value+='&#x1F3A3'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3ae.png" onclick="document.publicar.publicacion.value+='&#x1F3AE'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3af.png" onclick="document.publicar.publicacion.value+='&#x1F3AF'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3b0.png" onclick="document.publicar.publicacion.value+='&#x1F3B0'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3b1.png" onclick="document.publicar.publicacion.value+='&#x1F3B1'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3b2.png" onclick="document.publicar.publicacion.value+='&#x1F3B2'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3b3.png" onclick="document.publicar.publicacion.value+='&#x1F3B3'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3be.png" onclick="document.publicar.publicacion.value+='&#x1F3BE'" style="width: 25px; cursor: pointer"></td>
                </tr>
                <tr>
                    <td><img src="../img/emojis/deportes/1f3bf.png" onclick="document.publicar.publicacion.value+='&#x1F3BF'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3c0.png" onclick="document.publicar.publicacion.value+='&#x1F3C0'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3c1.png" onclick="document.publicar.publicacion.value+='&#x1F3C1'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3c2.png" onclick="document.publicar.publicacion.value+='&#x1F3C2'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3c3.png" onclick="document.publicar.publicacion.value+='&#x1F3C3'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3c4.png" onclick="document.publicar.publicacion.value+='&#x1F3C4'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3c6.png" onclick="document.publicar.publicacion.value+='&#x1F3C6'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3c8.png" onclick="document.publicar.publicacion.value+='&#x1F3C8'" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deportes/1f3ca.png" onclick="document.publicar.publicacion.value+='&#x1F3CA'" style="width: 25px; cursor: pointer"></td>
                </tr>
            </table>
        </div>
        <div id="notificationFooter">
            <table>
                <tr>
                    ...
                    <td><img src="../img/emojis/comida.png" alt="comidas" id="comida" name="comida" style="width: 25px; cursor: pointer"></td>
                    <td><img src="../img/emojis/deporte.png" alt="deportes" id="deporte" name="deporte" style="width: 25px; cursor: pointer"></td>

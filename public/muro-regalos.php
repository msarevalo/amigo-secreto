...
<div id="texto">
    ...
    <form method=\"post\" action=\"../back/regaloedit.php\" id=\"publicar\" name='publicar'>
        <textarea required maxlength=\"600\" rows=\"5\" cols=\"85\" placeholder=\"¿Quieres un viaje, un carro, una casa? ¡Escribe aquí qué es lo que quieres!\" id=\"publicacion\" name=\"publicacion\" onpaste=\"contarcaracteres();\" onkeyup=\"contarcaracteres();\">" . $resregalo[0][2] . "</textarea><br>
